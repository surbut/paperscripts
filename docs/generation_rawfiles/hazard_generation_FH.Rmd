...
for(i in seq(1:nrow(dat))){
  ...
  reg=glm(chd~prs.quant,data=f,family="binomial")
  ...
  reg=glm(chd~ldl.quant,data=d,family="binomial")
  ...
  reg=glm(chd~CURRSMK1,data=d,family="binomial")
  ...
  reg=glm(chd~AGE1,data=d,family="binomial")
  ...
  reg=glm(chd~sbp.quant,data=d,family="binomial")
  ...
  reg=glm(chd~chol.quant,data=d,family="binomial")
  ...
  reg=glm(chd~bmi.quant,data=d,family="binomial")
  ...
  reg=glm(chd~sex,data=d,family="binomial")
...
saveRDS(lowerbound,"output/hazards_rate_lowerbound_fh.rds")
saveRDS(upperbound,"output/hazards_rate_upperbound_fh.rds")

saveRDS(hazards,"~/Dropbox/paper_scripts/output/hazards_fhs.rds") 
