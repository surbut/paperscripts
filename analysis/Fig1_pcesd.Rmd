...
hazards=data.frame(readRDS("output/hazards_rate_amit_PCEQC.rds"))
...
r2_pce = r2_ukb_pce + theme_classic(base_size = 20)+theme(legend.position = "none")+ylim(0,0.15)+labs(x="Age of Risk Assessment, Years")
#hall_pce = hr_ukb_pce + theme_classic(base_size = 20) + tems +ylim(0.8,4.5)
hall_pce = hr_ukb_pce + theme_classic(base_size = 20) + tems +ylim(0.8,2)+theme(legend.position = "none")+labs(x="Age of Risk Assessment, Years")
```
