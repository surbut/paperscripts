...
tgt = c("Diabetes mellitus", "Smoking", "Polygenic score", "Systolic blood pressure", "Age", "High-density lipoprotein", "Total cholesterol")
...
hr_ukb_all_nolegend=hr_ukb_all+theme_classic(base_size = 20)+theme(legend.position = "none")+ylim(c(0.75,5)) 
...
r2_pce = r2_ukb_pce + theme_classic(base_size = 20)+theme(legend.position = "none") +ylim(0,0.10)
#hall_pce = hr_ukb_pce + theme_classic(base_size = 20) + tems +ylim(0.8,4.5)
hall_pce = hr_ukb_pce + theme_classic(base_size = 20) + tems +ylim(0.8,4.5)+theme(legend.position = "none")
```
