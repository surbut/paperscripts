...
g_youngprs=ggsurvplot(fit,
          ...
          ggtheme = theme_classic2(base_size=12, base_family = "Arial"),
           font.family = "Arial",
          palette=c("#3182BD","#31A354","#E6550D"),break.x.by=5,
...
g_midprs=ggsurvplot(fit,break.x.by=5,
...
gg1=ggarrange(g_youngprs$plot,g_midprs$plot,g_oldprs$plot,nrow=3,ncol=1,labels=c("A.","B.","C."),common.legend = T,height=10,width=10)
gg2=ggarrange(g_young$plot,g_mid$plot,g_old$plot,nrow=3,ncol=1,labels=c("D","F","G"),common.legend = T)
ggsave(gg1,dpi=300,filename = "Figs/interaction_time_byage1.tiff",height=10,width = 10)
ggsave(gg2,dpi=300,filename = "Figs/interaction_time_byage2.tiff")
```
