...
r2_fhs=r2+ggtitle("FHS")+theme_classic(base_size=15)+labs(x="Age of Risk Assessment, years")
r2u=r2u+ggtitle("UKB")+theme_classic(base_size=15)+labs(x="Age of Risk Assessment, years")

h1=h1+ggtitle("FHS")+theme_classic(base_size=15)+ylim(0,5)+labs(x="Age of Risk Assessment, years")
hall=hall+ggtitle("UKB")+theme_classic(base_size=15)+ylim(0,5)+labs(x="Age of Risk Assessment, years")
...
ggsave(print1,filename = "Figs/Fig1combined.tiff",dpi = 300,width = 10,height=6)
